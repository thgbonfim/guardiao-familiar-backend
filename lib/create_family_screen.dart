// create_family_screen.dart - (VERSÃO CORRIGIDA)
...
class _CreateFamilyScreenState extends State<CreateFamilyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Crie sua Família")),
      body: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          Text("Dê um nome ao seu grupo familiar para começar a cuidar de quem você ama.", textAlign: TextAlign.center, style: TextStyle(fontSize: 18),),
          SizedBox(height: 20),
          TextField(controller: _familyNameController, decoration: InputDecoration(labelText: "Ex: Família Silva"),),
          SizedBox(height: 20),
          ElevatedButton(onPressed: _createFamily, child: Text("CRIAR FAMÍLIA E ACESSAR"),),
        ],),
      ),
    );
  }
